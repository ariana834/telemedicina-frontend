...
const PLANS = [
    {
        ...
        perks: [
            ...
            'AI-powered medical form generation',
    ...
    },
    {
        ...
        price: 500,
        period: 'per year',
        badge: 'Best Value — Save 100 RON',
        perks: [
            'Everything in Monthly',
            'Priority specialist matching',
            'Extended medical history analytics',
    ...
    return (
        <Card
            ...
            sx={{
                ...
                minWidth: 280,
                maxWidth: 400,
                border: isAnnual ? '2px solid #8B7355' : '1.5px solid #EDE5D8',
                borderRadius: 3,
                bgcolor: isAnnual ? '#FFFCF8' : '#FDFAF6',
                position: 'relative',
                overflow: 'visible',
                transition: 'transform 0.18s, box-shadow 0.18s',
                '&:hover': {
                    transform: 'translateY(-4px)',
                    boxShadow: '0 12px 40px rgba(139,115,85,0.13)',
                },
            }}
        >
            {plan.badge && (
            ...
            <CardContent sx={{ p: 3.5 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 0.8, mb: 0.5 }}>
                    ...
                    <Typography sx={{ fontFamily: 'Lato', color: '#8B7355', fontWeight: 600, fontSize: '1rem' }}>
                        RON
                    </Typography>
                    <Typography sx={{ fontFamily: 'Lato', color: '#9E8B72', fontSize: '0.85rem' }}>
                        / {plan.period}
                    </Typography>
                </Box>

                {isAnnual && (
                    <Typography sx={{ fontFamily: 'Lato', fontSize: '0.8rem', color: '#8B7355', mb: 2, opacity: 0.8 }}>
                        ≈ 41.67 RON/month
                    </Typography>
                )}
                    ...
                    {plan.perks.map((perk, i) => (
                        <Box key={i} sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.2 }}>
                            <CheckCircleOutlineIcon
                                sx={{ fontSize: '1rem', color: '#8B7355', mt: 0.3, flexShrink: 0 }}
                            />
                            <Typography sx={{ fontFamily: 'Lato', fontSize: '0.88rem', color: '#6B5A47' }}>
                                {perk}
                            </Typography>
                        </Box>
                    ))}
                ...
                <Button
                    ...
                    sx={{
                        ...
                        py: 1.3,
                        borderRadius: 2,
                        bgcolor: isAnnual ? '#8B7355' : 'transparent',
                        borderColor: '#8B7355',
                        color: isAnnual ? '#FFFCF8' : '#8B7355',
                        '&:hover': {
                            bgcolor: isAnnual ? '#7A6348' : 'rgba(139,115,85,0.07)',
                            borderColor: '#7A6348',
                        },
                    }}
                >
...
function PaymentModal({ open, plan, onClose, onConfirm, paying }) {
    ...
    return (
        <Dialog
            open={open}
            onClose={!paying ? onClose : undefined}
            maxWidth="xs"
            fullWidth
            PaperProps={{
                sx: {
        ...
        >
            ...
            >
                ...
                {!paying && (
                    <IconButton size="small" onClick={onClose}>
                        <CloseIcon fontSize="small" sx={{ color: '#9E8B72' }} />
                    </IconButton>
                )}
            </DialogTitle>
            ...
            <DialogContent sx={{ pt: 1.5 }}>
                {plan && (
                    ...
                    >
                        <Box>
                            <Typography sx={{ fontFamily: 'Lato', fontSize: '0.8rem', color: '#9E8B72' }}>
                                Selected plan
                            </Typography>
                            <Typography sx={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, color: '#5C4A32', fontSize: '1.1rem' }}>
                                {plan.label} Subscription
                            </Typography>
                        </Box>
                        <Typography sx={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 700, color: '#8B7355', fontSize: '1.4rem' }}>
                            {plan.price} RON
                        </Typography>
                    </Box>
                )}
                        ...
                        InputProps={{
                            endAdornment: (
                                <InputAdornment position="end">
                                    <CreditCardIcon sx={{ color: '#9E8B72', fontSize: '1.2rem' }} />
                                </InputAdornment>
                            ),
                        }}
                        sx={inputSx}
            ...
            <DialogActions sx={{ px: 3, pb: 2.5, pt: 0 }}>
                <Button
                    ...
                    sx={{
                        ...
                        borderRadius: 2,
                        bgcolor: '#8B7355',
                        '&:hover': { bgcolor: '#7A6348' },
                        '&:disabled': { bgcolor: '#D4C9B8', color: '#9E8B72' },
                    }}
                >
                    {paying ? (
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            <CircularProgress size={16} sx={{ color: '#FFFCF8' }} />
...
function SuccessModal({ open, plan, subscription, onClose }) {
    return (
        <Dialog
            ...
            fullWidth
            PaperProps={{
                sx: { borderRadius: 3, bgcolor: '#FFFCF8', border: '1.5px solid #EDE5D8', overflow: 'hidden' },
            }}
        >
            <Box
                sx={{
            ...
            >
                ...
                <Typography sx={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.5rem', color: '#FFFCF8', fontWeight: 600 }}>
            ...
            <DialogContent sx={{ textAlign: 'center', pt: 3 }}>
                ...
                <Button
                    ...
                    onClick={onClose}
                    sx={{
                        fontFamily: 'Lato', fontWeight: 700, py: 1.2, borderRadius: 2,
                ...
                >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                        ...
                        <Box>
                            ...
                            <Typography sx={{ fontFamily: 'Lato', fontSize: '0.78rem', color: 'rgba(255,252,248,0.75)' }}>
                        ...
                        {[
                            ...
                            <Box key={item.label} sx={{ flex: '1 1 140px' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.6, mb: 0.3 }}>
                                    {item.icon}
                                    <Typography sx={{ fontFamily: 'Lato', fontSize: '0.75rem', color: '#9E8B72', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                                        {item.label}
                                    </Typography>
                                </Box>
                                <Typography sx={{ fontFamily: 'Lato', fontWeight: 700, color: '#5C4A32', fontSize: '0.95rem' }}>
                                    {item.value}
                                </Typography>
                            </Box>
                        ))}
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.8 }}>
                            ...
                            <Typography
                                sx={{
                                    ...
                                    fontSize: '0.8rem',
                                    fontWeight: 700,
                                    color: isExpiringSoon ? '#C0392B' : '#8B7355',
                                }}
                            >
                        ...
                        <LinearProgress
                            ...
                            sx={{
                                ...
                                '& .MuiLinearProgress-bar': {
                                    bgcolor: isExpiringSoon ? '#C0392B' : '#8B7355',
                                    borderRadius: 3,
                                },
                            }}
                        />
                    ...
                    <>
                        ...
                        <Box sx={{ px: 3, py: 2.5 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                                ...
                                <Typography sx={{ fontFamily: 'Lato', fontWeight: 700, color: '#5C4A32', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                                    Payment History
                                </Typography>
                            </Box>
                            <Stack spacing={1}>
                                {payments.map((p) => (
                                    ...
                                    >
                                        <Box>
                                            <Typography sx={{ fontFamily: 'Lato', fontSize: '0.82rem', color: '#5C4A32', fontWeight: 600 }}>
                                                {fmtShort(p.paymentDate)}
                                            </Typography>
                                            {p.transactionId && (
                                                <Typography sx={{ fontFamily: 'Lato', fontSize: '0.72rem', color: '#B0A090' }}>
                                                    {p.transactionId}
                                                </Typography>
                                            )}
                                        </Box>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                                            <Typography sx={{ fontFamily: 'Lato', fontWeight: 700, color: '#5C4A32', fontSize: '0.9rem' }}>
                                                {p.amount} RON
                                            </Typography>
                                            <Chip
                                                label={p.status}
...
export default function SubscriptionPage() {
    ...
    const [active, setActive] = useState(null);       // null = no active sub
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                setActive(sub);
                if (sub) {
                    const hist = await getPaymentHistory(token, sub.id);
    ...
    return (
        <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: '#F7F3EE' }}>
            ...
            >
                ...
                <Collapse in={!!error}>
                    <Alert
                        severity="error"
                        onClose={() => setError('')}
                        sx={{ mb: 2.5, borderRadius: 2, fontFamily: 'Lato' }}
                    >
                        {error}
                    </Alert>
                </Collapse>
                    ...
                    <Fade in timeout={400}>
                        <Box>
                            ...
                            >
                                ...
                                <Box>
                                    <Typography
                                        sx={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.25rem', fontWeight: 600, color: '#5C4A32', mb: 0.4 }}
                                    >
            ...
            <SuccessModal
                open={showSuccess}
                plan={PLANS.find((p) => p.type === newSubscription?.type)}
